...
mod tests {
    ...
    {
        bencher.iter(|| {
            black_box(project_euler::problem_1::sum_multiples_of_3_and_5_simd(1000));
        });
    }
    ...
    {
        bencher.iter(|| {
            black_box(project_euler::problem_1::sum_multiples_of_3_and_5_simd(10000));
        });
    }
    ...
    {
        bencher.iter(|| {
            black_box(project_euler::problem_1::sum_multiples_of_3_and_5_simd(100000));
        });
    }
    ...
    {
        bencher.iter(|| {
            black_box(project_euler::problem_1::sum_multiples_of_3_and_5_simd(1000000));
        });
    }
